const productos = [
    ...
    { id: 31, nombre: "Papas Pay PeiPo 500gr", medida: 1, familia: "snacks", cantidad: 1, precio: 3193.2, img: "photo/01payPeipo.png" },
    ...
    // Jugo Limon
    { id: 47, nombre: "Jugo limon Marolio 250cc", medida: 1, familia: "almacen", cantidad: 1, precio: 659.88, img: "photo/02jugoLimon.png" },
    { id: 48, nombre: "Jugo limon Marolio 500cc", medida: 1, familia: "almacen", cantidad: 1, precio: 899.89, img: "photo/02jugoLimon.png" },
    ...
    { id: 50, nombre: "Esencia de Vainilla Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 1103.38, img: "photo/02vainillaMarolio.png" },
    ...
    { id: 61, nombre: "Mayonesa Natura 250gr", medida: 1, familia: "almacen", cantidad: 1, precio: 650.20, img: "photo/02mayoNatura.png" },
    { id: 62, nombre: "Mayonesa Natura 500gr", medida: 1, familia: "almacen", cantidad: 1, precio: 1161.69, img: "photo/02mayoNatura.png" },
    // Savora
    { id: 63, nombre: "Savora 60gr", medida: 30, familia: "almacen", cantidad: 1, precio: 274.99, img: "photo/02savora.png" },
    ...
    { id: 67, nombre: "Cacao Nesquik 180gr", medida: 1, familia: "almacen", cantidad: 1, precio: 959.88, img: "photo/02cacao.png" },
    ...
    // Yerbas
    { id: 77, nombre: "Yerba Chamigo 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 1019.89, img: "photo/02yerbaChamigo.png" },
    ...
    // Condimentos
    { id: 94, nombre: "Condimento Oregano", medida: 10, familia: "almacen", cantidad: 1, precio: 381.60, img: "photo/02oregano.jpg" },
    { id: 95, nombre: "Condimento Aji Molido", medida: 10, familia: "almacen", cantidad: 1, precio: 399.60, img: "photo/02ajiMolido.jpg" },
    { id: 96, nombre: "Condimento Pimienta Negrade", medida: 10, familia: "almacen", cantidad: 1, precio: 623.78, img: "photo/02pimientaNegra.jpg" },
    { id: 97, nombre: "Condimento Pimenton", medida: 10, familia: "almacen", cantidad: 1, precio: 407.52, img: "photo/02pimenton.jpg" },
    { id: 98, nombre: "Condimento Pimienta Blanca", medida: 10, familia: "almacen", cantidad: 1, precio: 859.68, img: "photo/02pimientaBlanca.jpg" },
    { id: 99, nombre: "Condimento Mezcla Pizza", medida: 10, familia: "almacen", cantidad: 1, precio: 351.36, img: "photo/02adoboPizza.jpg" },
    ...
    { id: 102, nombre: "Condimento Provenzal", medida: 10, familia: "almacen", cantidad: 1, precio: 384.86, img: "photo/02provenzal.jpg" },
    { id: 441, nombre: "Condimento Bicarbonato", medida: 10, familia: "almacen", cantidad: 1, precio: 389.16, img: "photo/02bicarbonato.png" },
    ...
    { id: 115, nombre: "Pascualina Lit. Criolla", medida: 1, familia: "almacen", cantidad: 1, precio: 877.09, img: "photo/02pascualinaCriolla.png" },
    { id: 113, nombre: "Pascualina Lit. Hojaldre", medida: 1, familia: "almacen", cantidad: 1, precio: 877.09, img: "photo/02pascualinaHojaldre.png" },
    ...
    { id: 120, nombre: "Te Marolio", medida: 5, familia: "almacen", cantidad: 1, precio: 359.89, img: "photo/02teMarolio.png" },
    { id: 121, nombre: "Mate Cocido Union", medida: 5, familia: "almacen", cantidad: 1, precio: 815.89, img: "photo/02mateCocidoUnion.png" },
    ...
    // Gelatina Marolio
    { id: 151, nombre: "Gelatina Marolio Cereza", medida: 1, familia: "almacen", cantidad: 1, precio: 599.89, img: "photo/02gelatinaMaCere.png" },
    { id: 152, nombre: "Gelatina Marolio Frambuesa", medida: 1, familia: "almacen", cantidad: 1, precio: 599.89, img: "photo/02gelatinaMaFram.png" },
    { id: 153, nombre: "Gelatina Marolio Frutilla", medida: 1, familia: "almacen", cantidad: 1, precio: 599.89, img: "photo/02gelatinaMaFrut.png" },
    { id: 154, nombre: "Gelatina Light Frutilla", medida: 1, familia: "almacen", cantidad: 1, precio: 599.89, img: "photo/02gelatinaMaLight.png" },
    // Gelatina Esquisita
    ...
    // Bizcochuelo
    { id: 159, nombre: "Bizcochuelo Marolio Vainilla", medida: 1, familia: "almacen", cantidad: 1, precio: 1393.78, img: "photo/02biscochuelo.png" },

    // gelletitas
    { id: 416, nombre: "Tostadas Marolio Light", medida: 1, familia: "almacen", cantidad: 1, precio: 899.88, img: "photo/02tostada.png" },
    { id: 428, nombre: "Tostadas Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 899.88, img: "photo/02tostadaClasica.png" },
    ...
    // Jamon Natural
    { id: 166, nombre: "Jamon Natural Luvianka", medida: 6, familia: "fiambres", cantidad: 1, precio: 8082.99, img: "photo/03jamonNatLuvianka.png" },
    ...
    // Bondiolas
    { id: 194, nombre: "Bondiola Luvianka", medida: 1, familia: "fiambres", cantidad: 1, precio: 14986.80, img: "photo/03bondiolaLuvianka.png" },
    ...
    // Luvianka
    { id: 201, nombre: "Salchichon Luvianka Primavera", medida: 2.65, familia: "fiambres", cantidad: 1, precio: 2955.05, img: "photo/03salchichonLP.png" },
    { id: 202, nombre: "Salchichon Luvianka Jamon", medida: 2.65, familia: "fiambres", cantidad: 1, precio: 2955.05, img: "photo/03salchichonLJ.png" },
    // Los Calvos
    ...
    { id: 258, nombre: "Ajies Olifaza 900gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 7824.96, img: "photo/06ajiesOlifaza.png" },
    { id: 259, nombre: "Pickles Olifaza 1kg", medida: 1, familia: "encurtidos", cantidad: 1, precio: 2889.22, img: "photo/06pickles.png" },
    ...
    // Cayfar Lata
    { id: 261, nombre: "Lata Batata 5kg", medida: 1, familia: "mermeladas", cantidad: 1, precio: 11708.45, img: "photo/07lataBatata.png" },
    { id: 262, nombre: "Lata Batata Chocolate", medida: 1, familia: "mermeladas", cantidad: 1, precio: 11708.45, img: "photo/07lataChoco.png" },
    { id: 263, nombre: "Lata Membrillo 5kg", medida: 1, familia: "mermeladas", cantidad: 1, precio: 17670.32, img: "photo/07lataMembrillo.png" },

    // Cayfar cajon
    { id: 264, nombre: "Cajon Batata 5kg", medida: 1, familia: "mermeladas", cantidad: 1, precio: 9221.69, img: "photo/07cajonBatata.png" },
    { id: 265, nombre: "Cajon Batata Chocolate", medida: 1, familia: "mermeladas", cantidad: 1, precio: 9221.69, img: "photo/07cajonChoco.png" },
    ...
    // Mermelada Marolio    
    { id: 277, nombre: "Mermelada Marolio Frutilla", medida: 1, familia: "mermeladas", cantidad: 1, precio: 2177.85, img: "photo/07merMarolioFrutilla.png" },
    { id: 278, nombre: "Mermelada Marolio Ciruela", medida: 1, familia: "mermeladas", cantidad: 1, precio: 2177.85, img: "photo/07merMarolioCiruela.png" },
    { id: 279, nombre: "Mermelada Marolio Durazno", medida: 1, familia: "mermeladas", cantidad: 1, precio: 2177.85, img: "photo/07merMarolioDurazno.png" },
    ...
    { id: 307, nombre: "Poroto Alubia La Banda", medida: 1, familia: "conservas", cantidad: 1, precio: 635.88, img: "photo/08porotoAlubiaBanda.png" },
    ...
    { id: 329, nombre: "Anana Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 4319.88, img: "photo/08ananaMarolio.png" },
    { id: 330, nombre: "Coctel Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 3119.88, img: "photo/08coctelMarolio.png" },
    ...
    // desodorante ciell
    { id: 346, nombre: "Desodorante Ciell", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1839.89, img: "photo/09ciell.png" },
    // desodorante Dove
    { id: 347, nombre: "Desodorante Dove", medida: 1, familia: "perfumeria", cantidad: 1, precio: 2012.39, img: "photo/09desodoranteDove.png" },
    // desodorante Rolon Nivea
    { id: 348, nombre: "Desodorante Rolon Nivea", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1092.38, img: "photo/09desodoranteNivea.png" },
    ...
    { id: 351, nombre: "Colgate Herbal 70gr", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1163.13, img: "photo/09colgateHerbal.png" },
    ...
    // Toallita Lina
    { id: 364, nombre: "Toallitas Lina Anatomicas 8un", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.89, img: "photo/09linaAnatomica.png" },
    ...
    { id: 450, nombre: "Toallita Doncella c/alas 8nid", medida: 1, familia: "perfumeria", cantidad: 1, precio: 551.88, img: "photo/09doncella.png" },
    ...
    { id: 377, nombre: "Desodorante Ambiente Poet", medida: 1, familia: "limpieza", cantidad: 1, precio: 1264.89, img: "photo/10ambientePoet.png" },
    { id: 423, nombre: "Poet Musica Primavera", medida: 1, familia: "limpieza", cantidad: 1, precio: 1264.89, img: "photo/10ambienteTropical.png" },

    // Jabon Piso Esencial
    { id: 378, nombre: "J. Piso Esencial Tropicales", medida: 1, familia: "limpieza", cantidad: 1, precio: 558.02, img: "photo/10pisoEsTropicales.png" },
    { id: 379, nombre: "J. Piso Esencial Lavanda", medida: 1, familia: "limpieza", cantidad: 1, precio: 558.02, img: "photo/10pisoEsLavanda.png" },
    ...
    // Esponja Esencial
    { id: 383, nombre: "Esponja Esencial", medida: 1, familia: "limpieza", cantidad: 1, precio: 367.89, img: "photo/10esponjaEsencial.png" },
    ...
    { id: 403, nombre: "Rollo Cocina Sussex", medida: 1, familia: "limpieza", cantidad: 1, precio: 1724.89, img: "photo/10rolloSussex.png" },


    // Papel Higienico Esencial
    { id: 387, nombre: "Papel Hig Esencial texturado 6x30", medida: 1, familia: "limpieza", cantidad: 1, precio: 1954.89, img: "photo/10papelHigText6.jpg" },
    { id: 388, nombre: "Papel Hig Esencial Texturado 4x30", medida: 1, familia: "limpieza", cantidad: 1, precio: 1379.88, img: "photo/10papelHigText4.png" },
