const productos = [
    ...
    { id: 405, nombre: "Papa Tradicional 480gr", medida: 1, familia: "snacks", cantidad: 1, precio: 1621.02, img: "photo/01papaTradicional550.png" },
    { id: 406, nombre: "Papa Americana 480gr", medida: 1, familia: "snacks", cantidad: 1, precio: 1621.02, img: "photo/01papaAmericana550-120-60.png" },
    ...
    { id: 5, nombre: "Palito 500gr", medida: 1, familia: "snacks", cantidad: 1, precio: 1331.86, img: "photo/01palito800-120-65.png" },
    ...
    // Caldo Knorr
    { id: 40, nombre: "Caldo Knoor Verdura", medida: 24, familia: "almacen", cantidad: 1, precio: 86.28, img: "photo/02caldoVerdura.png" },
    { id: 41, nombre: "Caldo Knoor Gallina", medida: 24, familia: "almacen", cantidad: 1, precio: 86.28, img: "photo/02caldoGallina.png" },
    { id: 42, nombre: "Caldo Knoor Carne", medida: 24, familia: "almacen", cantidad: 1, precio: 86.28, img: "photo/02caldoCarne.png" },
    ...
    // Jugo Limon
    { id: 47, nombre: "Jugo limon Marolio 250cc", medida: 1, familia: "almacen", cantidad: 1, precio: 227.88, img: "photo/02jugoLimon.png" },
    { id: 48, nombre: "Jugo limon Marolio 500cc", medida: 1, familia: "almacen", cantidad: 1, precio: 317.88, img: "photo/02jugoLimon.png" },
    ...
    { id: 50, nombre: "Esencia de Vainilla Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 435.47, img: "photo/02vainillaMarolio.png" },
    ...
    { id: 53, nombre: "Aceite Marolio 900cc", medida: 6, familia: "almacen", cantidad: 1, precio: 707.89, img: "photo/02aceiteMarolio.png" },
    ...
    { id: 71, nombre: "Cafe Dolca Clasico 50gr", medida: 1, familia: "almacen", cantidad: 1, precio: 743.89, img: "photo/02cafeClasico.png" },
    { id: 72, nombre: "Cafe Dolca Suave 50gr", medida: 1, familia: "almacen", cantidad: 1, precio: 743.89, img: "photo/02cafeSuave.png" },
    // Cafe Marolio
    ...
    { id: 78, nombre: "Yerba Marolio 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 659.88, img: "photo/02yerbaMarolio.png" },
    { id: 79, nombre: "Yerba Union 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 947.88, img: "photo/02yerbaUnion.png" },
    { id: 435, nombre: "Yerba Union Liviana 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 779.88, img: "photo/02yerbaUnionLiviana.png" },
    { id: 80, nombre: "Yerba Taragui 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 947.88, img: "photo/02yerbaTaragui.png" },
    { id: 81, nombre: "Yerba Mañanita 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 935.88, img: "photo/02yerbaMananita.png" },
    ...
    { id: 86, nombre: "Pan Rallado Marolio 500gr", medida: 12, familia: "almacen", cantidad: 1, precio: 275.88, img: "photo/02panRallado.png" },
    { id: 87, nombre: "Polenta Marolio 500gr", medida: 16, familia: "almacen", cantidad: 1, precio: 191.89, img: "photo/02polenta.png" },
    { id: 438, nombre: "Vitina 250gr", medida: 1, familia: "almacen", cantidad: 1, precio: 395.88, img: "photo/02vitina.png" },

    // Salsas Benidorm
    { id: 88, nombre: "Benidorm Mayonesa", medida: 1, familia: "almacen", cantidad: 1, precio: 546.79, img: "photo/02benMayonesa.png" },
    { id: 89, nombre: "Benidorm Parmesano", medida: 1, familia: "almacen", cantidad: 1, precio: 711.49, img: "photo/02benParmesano.png" },
    { id: 90, nombre: "Benidorm Mostaza", medida: 1, familia: "almacen", cantidad: 1, precio: 711.49, img: "photo/02benMostaza.png" },
    { id: 91, nombre: "Benidorm Ketchup", medida: 1, familia: "almacen", cantidad: 1, precio: 711.49, img: "photo/02benKetchup.png" },
    { id: 92, nombre: "Benidorm Golf", medida: 1, familia: "almacen", cantidad: 1, precio: 711.49, img: "photo/02benGolf.png" },
    { id: 93, nombre: "Benidorm Cheddar", medida: 1, familia: "almacen", cantidad: 1, precio: 711.49, img: "photo/02benCheddar.png" },

    // Condimentos
    { id: 94, nombre: "Condimento Oregano", medida: 10, familia: "almacen", cantidad: 1, precio: 163.44, img: "photo/02oregano.jpg" },
    ...
    { id: 97, nombre: "Condimento Pimenton", medida: 10, familia: "almacen", cantidad: 1, precio: 210.52, img: "photo/02pimenton.jpg" },
    { id: 98, nombre: "Condimento Pimienta Blanca", medida: 10, familia: "almacen", cantidad: 1, precio: 414.22, img: "photo/02pimientaBlanca.jpg" },
    { id: 99, nombre: "Condimento Mezcla Pizza", medida: 10, familia: "almacen", cantidad: 1, precio: 141.98, img: "photo/02adoboPizza.jpg" },
    { id: 100, nombre: "Condimento Comino", medida: 10, familia: "almacen", cantidad: 1, precio: 136.39, img: "photo/02Comino.jpg" },
    ...
    { id: 104, nombre: "Ravioles Orali Pollo", medida: 1, familia: "almacen", cantidad: 1, precio: 549.32, img: "photo/02pollo.png" },
    { id: 105, nombre: "Ravioles Orali Verdura", medida: 1, familia: "almacen", cantidad: 1, precio: 549.32, img: "photo/02verdura.png" },
    ...
    { id: 112, nombre: "Empanadas Lit. Criolla", medida: 1, familia: "almacen", cantidad: 1, precio: 322.67, img: "photo/02empanadaCriolla.png" },
    { id: 114, nombre: "Empanadas Lit. Hojaldre", medida: 1, familia: "almacen", cantidad: 1, precio: 322.67, img: "photo/02empanadaHojaldre.png" },
    { id: 115, nombre: "Pascualina Lit. Criolla", medida: 1, familia: "almacen", cantidad: 1, precio: 396.48, img: "photo/02pascualinaCriolla.png" },
    { id: 113, nombre: "Pascualina Lit. Hojaldre", medida: 1, familia: "almacen", cantidad: 1, precio: 396.48, img: "photo/02pascualinaHojaldre.png" },
    ...
    // Te y Mate cocido ...
    { id: 119, nombre: "Te Taragui", medida: 5, familia: "almacen", cantidad: 1, precio: 239.87, img: "photo/02teTaragui.png" },
    { id: 120, nombre: "Te Marolio", medida: 5, familia: "almacen", cantidad: 1, precio: 191.88, img: "photo/02teMarolio.png" },
    { id: 121, nombre: "Mate Cocido Union", medida: 5, familia: "almacen", cantidad: 1, precio: 419.88, img: "photo/02mateCocidoUnion.png" },
    { id: 122, nombre: "Mate Cocido Marolio", medida: 5, familia: "almacen", cantidad: 1, precio: 251.88, img: "photo/02mateCocidoMarolio.png" },

    // Sopas Molto
    { id: 123, nombre: "Sopa Verdura Clásica", medida: 1, familia: "almacen", cantidad: 1, precio: 455.9, img: "photo/02sopaVerduraC.png" },
    { id: 124, nombre: "Sopa Zapallo Clásica", medida: 1, familia: "almacen", cantidad: 1, precio: 455.9, img: "photo/02sopaZapalloC.png" },
    { id: 125, nombre: "Sopa Verdura Light", medida: 1, familia: "almacen", cantidad: 1, precio: 455.9, img: "photo/02sopaVerduraL.png" },
    { id: 126, nombre: "Sopa Zapallo Light", medida: 1, familia: "almacen", cantidad: 1, precio: 455.9, img: "photo/02SopaZapalloL.png" },

    // Fideos Marolio
    { id: 127, nombre: "Fideos Marolio Tirabuzón", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoTira.png" },
    { id: 128, nombre: "Fideos Marolio Dadolitos", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoDado.png" },
    // {id: 129, nombre: "Fideos Marolio Ave María", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoAveM.png"},
    // {id: 130, nombre: "Fideos Marolio Coditos", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoCodi.png"},
    { id: 131, nombre: "Fideos Marolio Mostachol", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoMost.png" },
    { id: 132, nombre: "Fideos Marolio Tallarín", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoTall.png" },
    { id: 133, nombre: "Fideos Marolio Spaguetti", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoSpag.png" },
    { id: 134, nombre: "Fideos Marolio Munición", medida: 1, familia: "almacen", cantidad: 1, precio: 359.88, img: "photo/02fideoMuni.png" },
    ...
    // Pasteleria ... Flan
    { id: 138, nombre: "Flan Vainilla Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 239.89, img: "photo/02FlanMaVainilla.png" },
    { id: 139, nombre: "Flan D. Leche Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 239.89, img: "photo/02flanMaLeche.png" },
    ...
    // Postres
    { id: 157, nombre: "Postre Esquisita Vainilla", medida: 1, familia: "almacen", cantidad: 1, precio: 257.88, img: "photo/02postreVainilla.png" },
    { id: 158, nombre: "Postre Esquisita Chcocolate", medida: 1, familia: "almacen", cantidad: 1, precio: 257.88, img: "photo/02postreChoco.png" },
    // Bizcochuelo
    { id: 159, nombre: "Bizcochuelo Marolio Vainilla", medida: 1, familia: "almacen", cantidad: 1, precio: 767.88, img: "photo/02biscochuelo.png" },

    // gelletitas
    { id: 416, nombre: "Tostadas Marolio Light", medida: 1, familia: "almacen", cantidad: 1, precio: 466.08, img: "photo/02tostada.png" },
    { id: 428, nombre: "Tostadas Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 466.08, img: "photo/02tostadaClasica.png" },
    { id: 425, nombre: "ParNor Suavecitas", medida: 1, familia: "almacen", cantidad: 1, precio: 277.36, img: "photo/02parNorSuavecita.png" },
    { id: 425, nombre: "ParNor Marmoladas", medida: 1, familia: "almacen", cantidad: 1, precio: 277.36, img: "photo/02parNorMarmolada.png" },
    ...
    // Muzzarellas
    { id: 222, nombre: "Muzzarella Barraza", medida: 3, familia: "quesos", cantidad: 1, precio: 2679.33, img: "photo/04muzzaBarraza.png" },
    ...
    { id: 226, nombre: "Sardo Fresco", medida: 3, familia: "quesos", cantidad: 1, precio: 2178, img: "photo/04sardoFresco.png" },
    // {id: 227, nombre: "Sardo Semiduro", medida: 3, familia: "quesos", cantidad: 1, precio: 0, img: "photo/04sardoSemiduro.png"},
    { id: 228, nombre: "Reggianito Melincué", medida: 4, familia: "quesos", cantidad: 1, precio: 3286.48, img: "photo/04reggianito.png" },
    ...
    { id: 235, nombre: "Cheddar Feteado Tonadita x10", medida: 1, familia: "quesos", cantidad: 1, precio: 539.21, img: "photo/04cheddarTonadita.png" },
    ...
    // Sachet 90gr
    { id: 254, nombre: "Sachet Verdes .. 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 252.04, img: "photo/06sachetVerde.png" },
    { id: 255, nombre: "Sachet Descarozada 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 252.04, img: "photo/06sachetDesc.png" },
    { id: 256, nombre: "Sachet Negras .. 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 252.04, img: "photo/06sachetNegra.png" },
    { id: 257, nombre: "Sachet Morron 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 252.04, img: "photo/06sachetMorron.png" },

    // Ajies, Pickles, Anchoas
    { id: 258, nombre: "Ajies Olifaza 900gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 3366.92, img: "photo/06ajiesOlifaza.png" },
    { id: 259, nombre: "Pickles Olifaza 2kg", medida: 1, familia: "encurtidos", cantidad: 1, precio: 2119.29, img: "photo/06pickles.png" },
    ...
    {id: 451, nombre: "Mermelada Noel Durazno", medida: 1, familia: "mermeladas", cantidad: 1, precio: 515.87, img: "photo/07noelD.png"},
    ...
    // Mermelada Marolio    
    { id: 277, nombre: "Mermelada Marolio Frutilla", medida: 1, familia: "mermeladas", cantidad: 1, precio: 638.74, img: "photo/07merMarolioFrutilla.png" },
    // { id: 278, nombre: "Mermelada Marolio Ciruela", medida: 1, familia: "mermeladas", cantidad: 1, precio: 638.74, img: "photo/07merMarolioCiruela.png" },
    // { id: 279, nombre: "Mermelada Marolio Durazno", medida: 1, familia: "mermeladas", cantidad: 1, precio: 638.74, img: "photo/07merMarolioDurazno.png" },
    ...
    // Dulce de leche, Miel
    { id: 283, nombre: "Dulce de leche Punta", medida: 1, familia: "mermeladas", cantidad: 1, precio: 536.71, img: "photo/07dulcePunta.png" },
    ...
    // Atun Marolio
    { id: 295, nombre: "Atun Marolio Lom Aceite", medida: 1, familia: "conservas", cantidad: 1, precio: 1259.90, img: "photo/08lomitoMarolioA.png" },
    { id: 296, nombre: "Atun Marolio Lom Natural", medida: 1, familia: "conservas", cantidad: 1, precio: 1259.90, img: "photo/08lomitoMarolioN.png" },
    ...
    { id: 302, nombre: "Atun La Banda desm Natural", medida: 1, familia: "conservas", cantidad: 1, precio: 1054.59, img: "photo/08desmBandaN.png" },

    // Morron y legumbres
    { id: 303, nombre: "Morron Cuamana", medida: 1, familia: "conservas", cantidad: 1, precio: 889.54, img: "photo/08morronCumana.png" },
    { id: 400, nombre: "Lenteja Lata Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 263.89, img: "photo/08lentejaLataMarolio.png" },
    { id: 304, nombre: "Lentejas Tetra Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 275.89, img: "photo/08lentejasMarolio.png" },
    ...
    { id: 401, nombre: "Garbanzos Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 293.88, img: "photo/08garbanzoMarolio.png" },
    ...
    { id: 313, nombre: "Champignion Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 1597.05, img: "photo/08champignionMarolio.png" },
    { id: 314, nombre: "Palmitos Cumaná", medida: 1, familia: "conservas", cantidad: 1, precio: 1630.26, img: "photo/08palmitoCumana.png" },

    // Choclos
    { id: 315, nombre: "Choclo Marolio Amamrillo", medida: 1, familia: "conservas", cantidad: 1, precio: 575.88, img: "photo/08chocloMarolio.png" },
    { id: 316, nombre: "Choclo Marolio Cremoso", medida: 1, familia: "conservas", cantidad: 1, precio: 227.89, img: "photo/08cremosoMarolio.png" },
    { id: 317, nombre: "Choclo La Banda Amarillo", medida: 1, familia: "conservas", cantidad: 1, precio: 653.63, img: "photo/08chocloBanda.png" },
    { id: 318, nombre: "Choclo La Banda Cremoso", medida: 1, familia: "conservas", cantidad: 1, precio: 444.56, img: "photo/08cremosoBanda.png" },

    // Salsa Listas
    { id: 319, nombre: "Salsa Molto Pizza", medida: 1, familia: "conservas", cantidad: 1, precio: 323.88, img: "photo/08salsaPizza.png" },
    { id: 320, nombre: "Salsa Molto Portugueza", medida: 1, familia: "conservas", cantidad: 1, precio: 323.88, img: "photo/08salsaPortugueza.png" },
    { id: 321, nombre: "Salsa Molto Pomarola", medida: 1, familia: "conservas", cantidad: 1, precio: 323.88, img: "photo/08salsaPomarola.png" },
    { id: 322, nombre: "Salsa Molto Fileto", medida: 1, familia: "conservas", cantidad: 1, precio: 323.88, img: "photo/08salsaFileto.png" },
    ...
    // perita
    { id: 326, nombre: "Perita Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 299.89, img: "photo/08peritaMarolio.png" },
    ...
    { id: 329, nombre: "Anana Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 2219.88, img: "photo/08ananaMarolio.png" },
    { id: 330, nombre: "Coctel Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 1175.88, img: "photo/08coctelMarolio.png" },

    // ****************************************************** Perfumeria ****************************************************** //

    { id: 452, nombre: "Shampo Sedal Cr.Balance 10ml", medida: 24, familia: "perfumeria", cantidad: 1, precio: 32.29, img: "photo/09shampo10ml.png" },
    { id: 453, nombre: "Acondicionadors Cr.Balance 10ml", medida: 24, familia: "perfumeria", cantidad: 1, precio: 32.29, img: "photo/09shampo10ml.png" },

    // Shampoo Sedal
    { id: 331, nombre: "Shampo Sedal Restauración", medida: 1, familia: "perfumeria", cantidad: 1, precio: 494.39, img: "photo/09shSedalRestauracion.png" },
    { id: 332, nombre: "Shampo Sedal Rizo Definido", medida: 1, familia: "perfumeria", cantidad: 1, precio: 494.39, img: "photo/09shSedalRizo.png" },
    ...
    { id: 343, nombre: "Patrichs Black Label", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.89, img: "photo/09patrichsBlack.png" },
    { id: 344, nombre: "Patrichs Aviator", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.89, img: "photo/09PatrichsAviator.png" },
    { id: 345, nombre: "Patrichs Grand prix", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.89, img: "photo/09patrichsGrand.png" },
    // desodorante ciell
    { id: 346, nombre: "Desodorante Ciell", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1241.89, img: "photo/09ciell.png" },
    // desodorante Dove
    ...
    { id: 350, nombre: "Colgate Original 70gr", medida: 1, familia: "perfumeria", cantidad: 1, precio: 459.89, img: "photo/09colgateBlanco.png" },
    { id: 351, nombre: "Colgate Herbal 70gr", medida: 1, familia: "perfumeria", cantidad: 1, precio: 494.39, img: "photo/09colgateHerbal.png" },
    ...
    // Patricia Allen
    { id: 355, nombre: "J. Tocador P.Allen Humectacion", medida: 1, familia: "perfumeria", cantidad: 1, precio: 239.09, img: "photo/09pAllenHumecta.png" },
    { id: 356, nombre: "J. Tocador P.Allen Tropial", medida: 1, familia: "perfumeria", cantidad: 1, precio: 239.09, img: "photo/09pAllenTropical.png" },
    { id: 419, nombre: "J. Tocador P.Allen Intensidad", medida: 1, familia: "perfumeria", cantidad: 1, precio: 239.09, img: "photo/09pAllenIntensidad.png" },
    { id: 420, nombre: "J. Tocador P.Allen Suavidad", medida: 1, familia: "perfumeria", cantidad: 1, precio: 239.09, img: "photo/09pAllenSuavidad.png" },
    { id: 421, nombre: "J. Tocador P.Allen Equilibrio", medida: 1, familia: "perfumeria", cantidad: 1, precio: 239.09, img: "photo/09pAllenEquilibrio.png" },
    // Plusbelle
    ...
    // Algodon Doncella
    { id: 362, nombre: "Algodoón Doncella", medida: 1, familia: "perfumeria", cantidad: 1, precio: 310.39, img: "photo/09algodonDoncella.png" },
    ...
    // Esencial
    { id: 369, nombre: "Det Esencial Limon", medida: 1, familia: "limpieza", cantidad: 1, precio: 339.91, img: "photo/10detergenteEsLimon.png" },
    { id: 370, nombre: "Det Esencial Hierbas", medida: 1, familia: "limpieza", cantidad: 1, precio: 339.91, img: "photo/10detergenteEsHierbas.png" },
    // Cif
    { id: 371, nombre: "Detergente Cif 300", medida: 1, familia: "limpieza", cantidad: 1, precio: 448.39, img: "photo/10detergenteCif.png" },

    // Lavandina ... Ayudìn
    { id: 372, nombre: "Lavandina Ayudin 2ltr", medida: 1, familia: "limpieza", cantidad: 1, precio: 517.39, img: "photo/10lavandinaAy2.png" },
    { id: 373, nombre: "Lavandina Ayudin 1ltr", medida: 1, familia: "limpieza", cantidad: 1, precio: 310.39, img: "photo/10lavandinaAy2.png" },
    // Esencial
    { id: 374, nombre: "Lavandina Esencial 1ltr", medida: 1, familia: "limpieza", cantidad: 1, precio: 235.63, img: "photo/10lavandinaEsencial.png" },
    ...
    // { id: 376, nombre: "Desinfectante Ayudin Bebe", medida: 1, familia: "limpieza", cantidad: 1, precio: 644.88, img: "photo/10desinfectanteAyB.png" },
    { id: 446, nombre: "Desinfectante Ayudin Matinal", medida: 1, familia: "limpieza", cantidad: 1, precio: 644.88, img: "photo/10ayudinMatinal.png" },

    // Desodorante ambiente Poet
    { id: 377, nombre: "Desodorante Ambiente Poet", medida: 1, familia: "limpieza", cantidad: 1, precio: 574.89, img: "photo/10ambientePoet.png" },
    { id: 423, nombre: "Poet Musica Primavera", medida: 1, familia: "limpieza", cantidad: 1, precio: 574.89, img: "photo/10ambienteTropical.png" },

    // Jabon Piso Esencial
    { id: 378, nombre: "J. Psio Esencial Tropicales", medida: 1, familia: "limpieza", cantidad: 1, precio: 229.87, img: "photo/10pisoEsTropicales.png" },
    { id: 379, nombre: "J. Psio Esencial Lavanda", medida: 1, familia: "limpieza", cantidad: 1, precio: 229.87, img: "photo/10pisoEsLavanda.png" },

    // Jabon Polvo Ala
    { id: 380, nombre: "J. Polvo Ala Regular 400gr", medida: 1, familia: "limpieza", cantidad: 1, precio: 344.88, img: "photo/10alaRegular.png" },
    { id: 381, nombre: "J. Polvo Ala Matics 400gr", medida: 1, familia: "limpieza", cantidad: 1, precio: 344.88, img: "photo/10alaMatics.png" },

    // jabon Pan Ropa
    { id: 382, nombre: "J. pan Ropa", medida: 1, familia: "limpieza", cantidad: 1, precio: 183.89, img: "photo/10jabonPanRopa.png" },

    // Esponja Esencial
    { id: 383, nombre: "Esponja Esencial", medida: 1, familia: "limpieza", cantidad: 1, precio: 172.39, img: "photo/10esponjaEsencial.png" },
    ...
    { id: 389, nombre: "Papel Hig Esencial Blanco 4x30", medida: 1, familia: "limpieza", cantidad: 1, precio: 471.39, img: "photo/10papelHigBlanco.jpg" },
    ...
    {id: 394, nombre: "Lámpara Esencial 9w", medida: 1, familia: "limpieza", cantidad: 1, precio: 551.88, img: "photo/10lampara9.png"},
