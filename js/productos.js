const productos = [
    ...
    { id: 31, nombre: "Papas Pay PeiPo 500gr", medida: 1, familia: "snacks", cantidad: 1, precio: 2195.16, img: "photo/01payPeipo.png" },
    ...
    { id: 37, nombre: "Sal Fina Celusal 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 323.88, img: "photo/02salFinaCelusal.png" },
    { id: 38, nombre: "Sal Gruesa Celusal 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 221.88, img: "photo/02salGruesaCelusal.png" },
    { id: 39, nombre: "Sal Gruesa Marolio 1Kg", medida: 5, familia: "almacen", cantidad: 1, precio: 257.88, img: "photo/02salGruesaMarolio.png" },

    // Caldo Knorr
    { id: 40, nombre: "Caldo Knoor Verdura", medida: 24, familia: "almacen", cantidad: 1, precio: 94.68, img: "photo/02caldoVerdura.png" },
    { id: 41, nombre: "Caldo Knoor Gallina", medida: 24, familia: "almacen", cantidad: 1, precio: 94.68, img: "photo/02caldoGallina.png" },
    { id: 42, nombre: "Caldo Knoor Carne", medida: 24, familia: "almacen", cantidad: 1, precio: 94.68, img: "photo/02caldoCarne.png" },
    ...
    // Natura
    { id: 60, nombre: "Mayonesa Natura 125gr", medida: 20, familia: "almacen", cantidad: 1, precio: 252.22, img: "photo/02mayoNatura.png" },
    ...
    { id: 71, nombre: "Cafe Dolca Clasico 50gr", medida: 1, familia: "almacen", cantidad: 1, precio: 1199.88, img: "photo/02cafeClasico.png" },
    { id: 72, nombre: "Cafe Dolca Suave 50gr", medida: 1, familia: "almacen", cantidad: 1, precio: 1199.88, img: "photo/02cafeSuave.png" },
    // Cafe Marolio
    ...
    { id: 80, nombre: "Yerba Taragui 500gr", medida: 5, familia: "almacen", cantidad: 1, precio: 1499.88, img: "photo/02yerbaTaragui.png" },
    ...
    { id: 89, nombre: "Benidorm Parmesano", medida: 1, familia: "almacen", cantidad: 1, precio: 853.74, img: "photo/02benParmesano.png" },
    { id: 90, nombre: "Benidorm Mostaza", medida: 1, familia: "almacen", cantidad: 1, precio: 736.72, img: "photo/02benMostaza.png" },
    { id: 91, nombre: "Benidorm Ketchup", medida: 1, familia: "almacen", cantidad: 1, precio: 736.72, img: "photo/02benKetchup.png" },
    { id: 92, nombre: "Benidorm Golf", medida: 1, familia: "almacen", cantidad: 1, precio: 736.72, img: "photo/02benGolf.png" },
    { id: 93, nombre: "Benidorm Cheddar", medida: 1, familia: "almacen", cantidad: 1, precio: 908.93, img: "photo/02benCheddar.png" },
    ...
    // Pasteleria ... Flan
    { id: 139, nombre: "Flan D. Leche Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 311.88, img: "photo/02flanMaLeche.png" },
    { id: 138, nombre: "Flan Vainilla Marolio", medida: 1, familia: "almacen", cantidad: 1, precio: 311.88, img: "photo/02FlanMaVainilla.png" },
    ...
    // Bizcochuelo
    { id: 159, nombre: "Bizcochuelo Marolio Vainilla", medida: 1, familia: "almacen", cantidad: 1, precio: 839.88, img: "photo/02biscochuelo.png" },
    ...
    // Matambres ... LosiFar
    { id: 175, nombre: "Matambres Losifar Carne", medida: 2, familia: "fiambres", cantidad: 1, precio: 3592.51, img: "photo/03matambreLosiC.png" },
    { id: 176, nombre: "Matambres Losifar Pollo", medida: 2, familia: "fiambres", cantidad: 1, precio: 3592.51, img: "photo/03matambreLosiP.png" },
    // Campo Argentino
    // {id: 177, nombre: "Matambres Campo Carne", medida: 1.5, familia: "fiambres", cantidad: 1, precio: 1800.96, img: "photo/03matambreCampo.png"},
    { id: 440, nombre: "Matambres DyC", medida: 1.5, familia: "fiambres", cantidad: 1, precio: 3917.76, img: "photo/03matambreDyc.png" },

    // Mortadelas
    { id: 178, nombre: "Mortadela Bocha Calchaquil", medida: 7, familia: "fiambres", cantidad: 1, precio: 3596.12, img: "photo/03mortadelaCalcha.png" },
    { id: 179, nombre: "Mortadela Cañon Calchaquil", medida: 4, familia: "fiambres", cantidad: 1, precio: 3220.27, img: "photo/03mortadelaCanon.png" },
    { id: 180, nombre: "Mortadela Apetece", medida: 5, familia: "fiambres", cantidad: 1, precio: 2610.46, img: "photo/03mortadelaApetece.png" },
    ...
    { id: 188, nombre: "Salamines 42 Fino", medida: 0.75, familia: "fiambres", cantidad: 1, precio: 6880.31, img: "photo/03salamines42F.png" },
    { id: 189, nombre: "Salamines 42 Grueso", medida: 0.75, familia: "fiambres", cantidad: 1, precio: 6880.31, img: "photo/03salamines42G.png" },
    { id: 190, nombre: "Salamines 42 Longaniza", medida: 0.5, familia: "fiambres", cantidad: 1, precio: 6880.31, img: "photo/03salamines42L.png" },
    // Candelarios leopardo
    { id: 191, nombre: "Candelarios Los Calvos", medida: 0.5, familia: "fiambres", cantidad: 1, precio: 6880.31, img: "photo/03candelario42.png" },
    // { id: 427, nombre: "Candelarios leopardo", medida: 0.5, familia: "fiambres", cantidad: 1, precio: 1431.366, img: "photo/03leopardo.png" },
    // Baston
    { id: 192, nombre: "baston Los Calvos", medida: 1, familia: "fiambres", cantidad: 1, precio: 6880.31, img: "photo/03baston42.png" },
    ...
    // Pancetas
    { id: 196, nombre: "Panceta Los Calvos", medida: 2, familia: "fiambres", cantidad: 1, precio: 5655.25, img: "photo/03panceta42.png" },
    ...
    { id: 208, nombre: "Queso de credo Seoc", medida: 2.5, familia: "fiambres", cantidad: 1, precio: 1637.03, img: "photo/03quesoCerdoSeoc.png" },
    ...
    { id: 228, nombre: "Reggianito Melincué", medida: 4, familia: "quesos", cantidad: 1, precio: 3997.06, img: "photo/04reggianito.png" },
    ...
    { id: 242, nombre: "Crema de leche 200cc", medida: 1, familia: "lacteos", cantidad: 1, precio: 742.14, img: "photo/05cremaLeche.png" },
    ...
    { id: 291, nombre: "Sardina marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 1079.88, img: "photo/08sardinaMarolio.png" },
    ...
    { id: 400, nombre: "Lenteja Lata Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 323.87, img: "photo/08lentejaLataMarolio.png" },
    { id: 304, nombre: "Lentejas Tetra Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 323.87, img: "photo/08lentejasMarolio.png" },
    ...
    { id: 452, nombre: "Shampo Sedal Cr.Balance 10ml", medida: 24, familia: "perfumeria", cantidad: 1, precio: 37.84, img: "photo/09shampo10ml.png" },
    { id: 453, nombre: "Acondicionadors Cr.Balance 10ml", medida: 24, familia: "perfumeria", cantidad: 1, precio: 37.84, img: "photo/09shampo10ml.png" },

    // Shampoo Sedal
    { id: 331, nombre: "Shampo Sedal Restauración", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalRestauracion.png" },
    { id: 332, nombre: "Shampo Sedal Rizo Definido", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalRizo.png" },
    { id: 333, nombre: "Shampo Sedal Liso perfecto", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalLiso.png" },
    { id: 334, nombre: "Shampo Sedal Balance", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalBalance.png" },
    { id: 335, nombre: "Shampo Sedal Creamidas", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalCreamidas.png" },
    { id: 454, nombre: "Shampo Sedal Balance 340ml", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1034.89, img: "photo/09shSedalBalance.png" },

    // Crema Sedal
    { id: 336, nombre: "Crema Sedal Restauración", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalRestauracion.png" },
    { id: 337, nombre: "Crema Sedal Rizo Definido", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalRizo.png" },
    { id: 338, nombre: "Crema Sedal Liso perfecto", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalLiso.png" },
    { id: 339, nombre: "Crema Sedal Balance", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalBalance.png" },
    { id: 340, nombre: "Crema Sedal Creamidas", medida: 1, familia: "perfumeria", cantidad: 1, precio: 689.88, img: "photo/09shSedalCreamidas.png" },
    { id: 454, nombre: "Crema Sedal Balance 340ml", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1034.89, img: "photo/09shSedalBalance.png" },

    // Shampoo Plusbelle
    { id: 341, nombre: "Shampo Plusbelle Manzana", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1080.89, img: "photo/09shPlusbelle.png" },
    { id: 429, nombre: "Acondicionador Plusbelle", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1080.89, img: "photo/09shPlusbelle.png" },
    // Shampoo J&J
    ...
    { id: 343, nombre: "Patrichs Black Label", medida: 1, familia: "perfumeria", cantidad: 1, precio: 977.39, img: "photo/09patrichsBlack.png" },
    { id: 344, nombre: "Patrichs Aviator", medida: 1, familia: "perfumeria", cantidad: 1, precio: 977.39, img: "photo/09PatrichsAviator.png" },
    { id: 345, nombre: "Patrichs Grand prix", medida: 1, familia: "perfumeria", cantidad: 1, precio: 977.39, img: "photo/09patrichsGrand.png" },
    // desodorante ciell
    ...
    { id: 431, nombre: "Desodorante Axe Marine", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1034.89, img: "photo/09axe.png" },
    ...
    { id: 350, nombre: "Colgate Original 70gr", medida: 1, familia: "perfumeria", cantidad: 1, precio: 649.75, img: "photo/09colgateBlanco.png" },
    { id: 351, nombre: "Colgate Herbal 70gr", medida: 1, familia: "perfumeria", cantidad: 1, precio: 649.75, img: "photo/09colgateHerbal.png" },
    ...
    { id: 352, nombre: "J. Tocador Rexona Sensible", medida: 1, familia: "perfumeria", cantidad: 1, precio: 344.88, img: "photo/09rexonaSensible.png" },
    { id: 353, nombre: "J. Tocador Rexona Cotton", medida: 1, familia: "perfumeria", cantidad: 1, precio: 344.88, img: "photo/09rexonaCotton.png" },
    { id: 354, nombre: "J. Tocador Rexona Orchid", medida: 1, familia: "perfumeria", cantidad: 1, precio: 344.88, img: "photo/09rexonaOrchid.png" },
    { id: 457, nombre: "J. Tocador Rexona Active", medida: 1, familia: "perfumeria", cantidad: 1, precio: 344.88, img: "photo/09jabRexonaActive.png" },
    // Patricia Allen
    ...
    { id: 381, nombre: "J. Polvo Ala Matics 400gr", medida: 1, familia: "limpieza", cantidad: 1, precio: 436.88, img: "photo/10alaMatics.png" },

    // jabon Pan Ropa
    { id: 382, nombre: "J.pan Ropa Zorro", medida: 1, familia: "limpieza", cantidad: 1, precio: 302.27, img: "photo/10jabonPanRopa.png" },
    ...
    { id: 385, nombre: "Rollo Cocina Esencial", medida: 1, familia: "limpieza", cantidad: 1, precio: 862.39, img: "photo/10rolloEsencial.png" },
    { id: 386, nombre: "Rollo Cocina Marolio", medida: 1, familia: "limpieza", cantidad: 1, precio: 862.39, img: "photo/10rolloMarolio.png" },
    ...
    { id: 389, nombre: "Papel Hig Esencial Blanco 4x30", medida: 1, familia: "limpieza", cantidad: 1, precio: 804.89, img: "photo/10papelHigBlanco.jpg" },
    ...
    {id: 394, nombre: "Lámpara Esencial 9w", medida: 1, familia: "limpieza", cantidad: 1, precio: 827.88, img: "photo/10lampara9.png"},
    // { id: 395, nombre: "Lámpara Esencial 12w", medida: 1, familia: "limpieza", cantidad: 1, precio: 689.90, img: "photo/10lampara.png" },

    // Insecticida Selton
    { id: 396, nombre: "Insecticida Selton", medida: 1, familia: "limpieza", cantidad: 1, precio: 896.89, img: "photo/10insecticida.png" },
    { id: 397, nombre: "Raid Mata Cucaracha", medida: 1, familia: "limpieza", cantidad: 1, precio: 1218.89, img: "photo/10raid.png" },
