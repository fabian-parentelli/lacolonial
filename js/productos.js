const productos = [
    ...
    { id: 29, nombre: "Palito Frontys", medida: 1, familia: "snacks", cantidad: 1, precio: 2553.41, img: "photo/01palitoFrontys.png" },

    // Otros
    { id: 30, nombre: "Nachos Macritas 90gr", medida: 1, familia: "snacks", cantidad: 1, precio: 833.1, img: "photo/01nachosMacritas.png" },
    { id: 31, nombre: "Papas Pay PeiPo 500gr", medida: 1, familia: "snacks", cantidad: 1, precio: 2524.50, img: "photo/01payPeipo.png" },
    { id: 398, nombre: "Batata Quento 80gr", medida: 6, familia: "snacks", cantidad: 1, precio: 844.8, img: "photo/01batata.png" },
    ...
    // Caldo Knorr
    { id: 40, nombre: "Caldo Knoor Verdura", medida: 24, familia: "almacen", cantidad: 1, precio: 155.88, img: "photo/02caldoVerdura.png" },
    { id: 41, nombre: "Caldo Knoor Gallina", medida: 24, familia: "almacen", cantidad: 1, precio: 155.88, img: "photo/02caldoGallina.png" },
    { id: 42, nombre: "Caldo Knoor Carne", medida: 24, familia: "almacen", cantidad: 1, precio: 155.88, img: "photo/02caldoCarne.png" },
    ...
    { id: 48, nombre: "Jugo limon Marolio 500cc", medida: 1, familia: "almacen", cantidad: 1, precio: 803.88, img: "photo/02jugoLimon.png" },
    ...
    { id: 64, nombre: "Savora 250gr", medida: 1, familia: "almacen", cantidad: 1, precio: 5649.89, img: "photo/02savora.png" },
    // Ketchup
    { id: 65, nombre: "ketchup 60gr", medida: 30, familia: "almacen", cantidad: 1, precio: 251.89, img: "photo/02ketchup.png" },
    ...
    // Cafe Marolio
    { id: 73, nombre: "Cafe Marolio 100gr", medida: 1, familia: "almacen", cantidad: 1, precio: 2759.88, img: "photo/02cafeMarolio.png" },
    { id: 74, nombre: "Cafe Marolio .. 50gr", medida: 1, familia: "almacen", cantidad: 1, precio: 1559.9, img: "photo/02cafeMarolio.png" },
    // Cafe Pocillo
    ...
    { id: 85, nombre: "Harina Pizza ..... 1kg", medida: 5, familia: "almacen", cantidad: 1, precio: 1017.75, img: "photo/02harinaPizza.png" },
    ...
    // Ravioles Orali
    { id: 103, nombre: "Ravioles Orali Ricota", medida: 1, familia: "almacen", cantidad: 1, precio: 980.66, img: "photo/02ricota.png" },
    { id: 104, nombre: "Ravioles Orali Pollo", medida: 1, familia: "almacen", cantidad: 1, precio: 980.66, img: "photo/02pollo.png" },
    { id: 105, nombre: "Ravioles Orali Verdura", medida: 1, familia: "almacen", cantidad: 1, precio: 980.66, img: "photo/02verdura.png" },
    ...
    { id: 108, nombre: "Tapas Oralitas", medida: 1, familia: "almacen", cantidad: 1, precio: 603.05, img: "photo/02oralita.png" },
    ...
    { id: 112, nombre: "Empanadas Lit. Criolla", medida: 1, familia: "almacen", cantidad: 1, precio: 683.93, img: "photo/02empanadaCriolla.png" },
    { id: 114, nombre: "Empanadas Lit. Hojaldre", medida: 1, familia: "almacen", cantidad: 1, precio: 683.93, img: "photo/02empanadaHojaldre.png" },
    { id: 115, nombre: "Pascualina Lit. Criolla", medida: 1, familia: "almacen", cantidad: 1, precio: 850.70, img: "photo/02pascualinaCriolla.png" },
    { id: 113, nombre: "Pascualina Lit. Hojaldre", medida: 1, familia: "almacen", cantidad: 1, precio: 850.70, img: "photo/02pascualinaHojaldre.png" },
    ...
    { id: 121, nombre: "Mate Cocido Union", medida: 5, familia: "almacen", cantidad: 1, precio: 695.88, img: "photo/02mateCocidoUnion.png" },
    ...
    // Vinagres
    { id: 136, nombre: "Vinagre Alcohol 500", medida: 1, familia: "almacen", cantidad: 1, precio: 419.88, img: "photo/02vinagreA.png" },
    { id: 430, nombre: "Vinagre Alcohol 1ltr", medida: 1, familia: "almacen", cantidad: 1, precio: 623.88, img: "photo/02vinagreA.png" },
    { id: 137, nombre: "Vinagre Manzana 500", medida: 1, familia: "almacen", cantidad: 1, precio: 623.88, img: "photo/02vinagreM.png" },
    ...
    // Jamon Natural
    { id: 166, nombre: "Jamon Natural Luvianka", medida: 6, familia: "fiambres", cantidad: 1, precio: 7966.60, img: "photo/03jamonNatLuvianka.png" },
    ...
    // Fiambre Paleta
    { id: 170, nombre: "Paleta Comarca", medida: 4, familia: "fiambres", cantidad: 1, precio: 4912.24, img: "photo/03paletaComarca.png" },
    ...
    { id: 173, nombre: "Paleta Jet Food", medida: 5.5, familia: "fiambres", cantidad: 1, precio: 2312.64, img: "photo/03paletaJetFood.png" },
    { id: 404, nombre: "Paleta Riosol", medida: 6, familia: "fiambres", cantidad: 1, precio: 2368.13, img: "photo/03paletaRiosol.png" },

    // Crudo
    { id: 174, nombre: "Crudo sol de Avellaneda", medida: 3, familia: "fiambres", cantidad: 1, precio: 11176.71, img: "photo/03crudoSol.png" },
    ...
    { id: 440, nombre: "Matambres DyC", medida: 1.5, familia: "fiambres", cantidad: 1, precio: 5987.52, img: "photo/03matambreDyc.png" },
    ...
    { id: 219, nombre: "Barra Esnaola", medida: 4, familia: "quesos", cantidad: 1, precio: 4561.52, img: "photo/04barraEsnaola.png" },
    ...
    // Sachet 90gr
    { id: 254, nombre: "Sachet Verdes .. 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 987.22, img: "photo/06sachetVerde.png" },
    { id: 255, nombre: "Sachet Descarozada 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 987.22, img: "photo/06sachetDesc.png" },
    { id: 256, nombre: "Sachet Negras .. 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 987.22, img: "photo/06sachetNegra.png" },
    { id: 257, nombre: "Sachet Morron 70gr", medida: 1, familia: "encurtidos", cantidad: 1, precio: 987.22, img: "photo/06sachetMorron.png" },
    ...
    // Mermelada Dulcor
    { id: 267, nombre: "Mermelada Dulcor Frutilla", medida: 1, familia: "mermeladas", cantidad: 1, precio: 1531.13, img: "photo/07dulcorFrutilla.png" },
    ...
    // Mermelada Cormillot
    { id: 270, nombre: "Mermelada Cormillot Frutilla", medida: 1, familia: "mermeladas", cantidad: 1, precio: 1605.70, img: "photo/07cormillotFrutilla.png" },
    {id: 271, nombre: "Mermelada Cormillot Ciruela", medida: 1, familia: "mermeladas", cantidad: 1, precio: 1605.70, img: "photo/07cormillotCiruela.png"},
    {id: 272, nombre: "Mermelada Cormillot Durazno", medida: 1, familia: "mermeladas", cantidad: 1, precio: 1605.70, img: "photo/07cormillotDurazno.png"},
    ...
    // Mermelada Marolio    
    { id: 277, nombre: "Mermelada Marolio Frutilla", medida: 1, familia: "mermeladas", cantidad: 1, precio: 1524.45, img: "photo/07merMarolioFrutilla.png" },
    { id: 278, nombre: "Mermelada Marolio Ciruela", medida: 1, familia: "mermeladas", cantidad: 1, precio: 1147.13, img: "photo/07merMarolioCiruela.png" },
    { id: 279, nombre: "Mermelada Marolio Durazno", medida: 1, familia: "mermeladas", cantidad: 1, precio: 1147.13, img: "photo/07merMarolioDurazno.png" },
    ...
    { id: 291, nombre: "Sardina marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 1679.88, img: "photo/08sardinaMarolio.png" },
    ...
    // Atun Marolio
    { id: 295, nombre: "Atun Marolio Lom Aceite", medida: 1, familia: "conservas", cantidad: 1, precio: 2494.67, img: "photo/08lomitoMarolioA.png" },
    { id: 296, nombre: "Atun Marolio Lom Natural", medida: 1, familia: "conservas", cantidad: 1, precio: 2494.67, img: "photo/08lomitoMarolioN.png" },
    
    { id: 297, nombre: "Atun Dique Desm Aceite", medida: 1, familia: "conservas", cantidad: 1, precio: 1439.89, img: "photo/08desmDiqueA.png" },
    ...
    { id: 304, nombre: "Lentejas Tetra Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 559.89, img: "photo/08lentejasMarolio.png" },
    ...
    // Arvejas y Jardinera
    { id: 308, nombre: "Arvejas Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 479.88, img: "photo/08arvejaMarolio.png" },
    // {id: 309, nombre: "Arvejas La Banda", medida: 1, familia: "conservas", cantidad: 1, precio: 116.53, img: "photo/08arvejaBanda.png"},
    { id: 310, nombre: "Jardinera Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 599.89, img: "photo/08jardineraMarolio.png" },
    ...
    // Salsa Listas
    { id: 319, nombre: "Salsa Molto Pizza", medida: 1, familia: "conservas", cantidad: 1, precio: 779.88, img: "photo/08salsaPizza.png" },
    { id: 320, nombre: "Salsa Molto Portugueza", medida: 1, familia: "conservas", cantidad: 1, precio: 779.88, img: "photo/08salsaPortugueza.png" },
    { id: 321, nombre: "Salsa Molto Pomarola", medida: 1, familia: "conservas", cantidad: 1, precio: 779.88, img: "photo/08salsaPomarola.png" },
    { id: 322, nombre: "Salsa Molto Fileto", medida: 1, familia: "conservas", cantidad: 1, precio: 779.88, img: "photo/08salsaFileto.png" },
    // Salsa marolio
    ...
    // Frutales
    { id: 328, nombre: "Durazno Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 1799.88, img: "photo/08duraznoMarolio.png" },
    { id: 329, nombre: "Anana Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 3839.90, img: "photo/08ananaMarolio.png" },
    { id: 330, nombre: "Coctel Marolio", medida: 1, familia: "conservas", cantidad: 1, precio: 2759.88, img: "photo/08coctelMarolio.png" },

    // ****************************************************** Perfumeria ****************************************************** //

    { id: 452, nombre: "Shampo Sedal Cr.Balance 10ml", medida: 24, familia: "perfumeria", cantidad: 1, precio: 65.89, img: "photo/09shampo10ml.png" },
    ...
    { id: 454, nombre: "Shampo Sedal Balance 340ml", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1609.88, img: "photo/09shSedalBalance.png" },
    ...
    { id: 454, nombre: "Crema Sedal Balance 340ml", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1609.88, img: "photo/09shSedalBalance.png" },

    // Shampoo Plusbelle
    { id: 341, nombre: "Shampo Plusbelle Manzana", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1414.38, img: "photo/09shPlusbelle.png" },
    { id: 429, nombre: "Acondicionador Plusbelle", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1414.38, img: "photo/09shPlusbelle.png" },
    // Shampoo J&J
    { id: 342, nombre: "Shampo JyJ 200ml", medida: 1, familia: "perfumeria", cantidad: 1, precio: 2587.39, img: "photo/09shJ&j.png" },
    ...
    // desodorante Dove
    { id: 347, nombre: "Desodorante Dove", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1839.89, img: "photo/09desodoranteDove.png" },
    ...
    { id: 431, nombre: "Desodorante Axe Marine", medida: 1, familia: "perfumeria", cantidad: 1, precio: 1494.89, img: "photo/09axe.png" },
    ...
    { id: 352, nombre: "J. Tocador Rexona Sensible", medida: 1, familia: "perfumeria", cantidad: 1, precio: 551.89, img: "photo/09rexonaSensible.png" },
    { id: 353, nombre: "J. Tocador Rexona Cotton", medida: 1, familia: "perfumeria", cantidad: 1, precio: 551.89, img: "photo/09rexonaCotton.png" },
    ...
    // Patricia Allen
    { id: 355, nombre: "J. Tocador P.Allen Humectacion", medida: 1, familia: "perfumeria", cantidad: 1, precio: 551.89, img: "photo/09pAllenHumecta.png" },
    { id: 356, nombre: "J. Tocador P.Allen Tropial", medida: 1, familia: "perfumeria", cantidad: 1, precio: 551.89, img: "photo/09pAllenTropical.png" },
    { id: 419, nombre: "J. Tocador P.Allen Intensidad", medida: 1, familia: "perfumeria", cantidad: 1, precio: 551.89, img: "photo/09pAllenIntensidad.png" },
    ...
    // Cif
    { id: 371, nombre: "Detergente Cif 300", medida: 1, familia: "limpieza", cantidad: 1, precio: 804.89, img: "photo/10detergenteCif.png" },
    ...
    // Esencial
    { id: 374, nombre: "Lavandina Esencial 1ltr", medida: 1, familia: "limpieza", cantidad: 1, precio: 517.39, img: "photo/10lavandinaEsencial.png" },

    // Desinfectante Ayudin
    { id: 375, nombre: "Desinfectante Ayudin Clasico", medida: 1, familia: "limpieza", cantidad: 1, precio: 1397.14, img: "photo/10desinfectanteAyC.png" },
    // { id: 376, nombre: "Desinfectante Ayudin Bebe", medida: 1, familia: "limpieza", cantidad: 1, precio: 1397.14, img: "photo/10desinfectanteAyB.png" },
    ...
    { id: 377, nombre: "Desodorante Ambiente Poet", medida: 1, familia: "limpieza", cantidad: 1, precio: 1241.88, img: "photo/10ambientePoet.png" },
    { id: 423, nombre: "Poet Musica Primavera", medida: 1, familia: "limpieza", cantidad: 1, precio: 1241.88, img: "photo/10ambienteTropical.png" },

    // Jabon Piso Esencial
    { id: 378, nombre: "J. Psio Esencial Tropicales", medida: 1, familia: "limpieza", cantidad: 1, precio: 459.88, img: "photo/10pisoEsTropicales.png" },
    { id: 379, nombre: "J. Psio Esencial Lavanda", medida: 1, familia: "limpieza", cantidad: 1, precio: 459.88, img: "photo/10pisoEsLavanda.png" },
    ...
    // jabon Pan Ropa
    { id: 382, nombre: "J.pan Ropa Zorro", medida: 1, familia: "limpieza", cantidad: 1, precio: 540.38, img: "photo/10jabonPanRopa.png" },

    // Esponja Esencial
    { id: 383, nombre: "Esponja Esencial", medida: 1, familia: "limpieza", cantidad: 1, precio: 275.88, img: "photo/10esponjaEsencial.png" },

    // Limpia Vidrios
    { id: 384, nombre: "Limpiavidrios Zorro", medida: 1, familia: "limpieza", cantidad: 1, precio: 1494.87, img: "photo/10limpiaVidriosZorro.png" },

    // Rollo Cocina Esencial
    { id: 385, nombre: "Rollo Cocina Esencial", medida: 1, familia: "limpieza", cantidad: 1, precio: 1322.39, img: "photo/10rolloEsencial.png" },
    { id: 386, nombre: "Rollo Cocina Marolio", medida: 1, familia: "limpieza", cantidad: 1, precio: 1322.39, img: "photo/10rolloMarolio.png" },

    { id: 403, nombre: "Rollo Cocina Sussex", medida: 1, familia: "limpieza", cantidad: 1, precio: 1610.88, img: "photo/10rolloSussex.png" },


    // Papel Higienico Esencial
    { id: 387, nombre: "Papel Hig Esencial texturado 6x30", medida: 1, familia: "limpieza", cantidad: 1, precio: 1724.88, img: "photo/10papelHigText6.jpg" },
    { id: 388, nombre: "Papel Hig Esencial Texturado 4x30", medida: 1, familia: "limpieza", cantidad: 1, precio: 1149.88, img: "photo/10papelHigText4.png" },
    { id: 389, nombre: "Papel Hig Esencial Blanco 4x30", medida: 1, familia: "limpieza", cantidad: 1, precio: 1679.88, img: "photo/10papelHigBlanco.jpg" },
