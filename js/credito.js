const vecinos = [
    {fecha: "02-feb", tipo: "Factura 46524", credito: 62286.34, haber: 0, saldo: 91340.47},
    ...
    {fecha: "12-ene", tipo: "Fcatura 46166", credito: 114125.02, haber: 0, saldo: 165141.26},

    {fecha: "11-ene", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 51016.24},
    {fecha: "09-ene", tipo: "Mercado Pago", credito: 0, haber: 30000, saldo: 71016.24},
    {fecha: "09-ene", tipo: "Factura 46106", credito: 7041.36, haber: 0, saldo: 101016.24},

    {fecha: "08-ene", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 93974.88},
    {fecha: "05-ene", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 113974.88},
    {fecha: "05-ene", tipo: "Factura 46068", credito: 33980.59, haber: 0, saldo: 133974.88},

    {fecha: "04-ene", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 99994.29},
    {fecha: "04-ene", tipo: "Factura 46040", credito: 51375.84, haber: 0, saldo: 119994.29},

    {fecha: "02-ene", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 68618.45},
    {fecha: "29-dic", tipo: "Mercado Pago", credito: 0, haber: 50000, saldo: 88618.45},
    {fecha: "29-dic", tipo: "Factura 45962", credito: 68195.64, haber: 0, saldo: 138618.45},

    {fecha: "28-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 70422.81},
    {fecha: "26-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 90422.81},
    {fecha: "26-dic", tipo: "Factura 45900", credito: 6976.80, haber: 0, saldo: 110422.81},

    {fecha: "22-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 103446.01},
    {fecha: "22-dic", tipo: "Factura 45872", credito: 46718.26, haber: 0, saldo: 123446.01},

    {fecha: "21-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 76727.75},
    {fecha: "21-dic", tipo: "Factura 45862", credito: 54517.64, haber: 0, saldo: 96727.75},

    {fecha: "19-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 42210.11},
    {fecha: "19-dic", tipo: "Factura 45806", credito: 10512.20, haber: 0, saldo: 62210.11},

    {fecha: "18-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 51697.91},
    {fecha: "18-dic", tipo: "Factura 45788", credito: 46182.44, haber: 0, saldo: 71697.91},

    {fecha: "15-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 255515.47},
    {fecha: "14-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 45515.47},
    {fecha: "12-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 65515.47},
    {fecha: "12-dic", tipo: "Factura 45706", credito: 28138.60, haber: 0, saldo: 85515.47},

    {fecha: "11-dic", tipo: "Mercado Pago", credito: 0, haber: 30000, saldo: 57376.87},
    {fecha: "08-dic", tipo: "Mercado Pago", credito: 0, haber: 40000, saldo: 87376.87},
    {fecha: "08-dic", tipo: "Factura 45668", credito: 75739.74, haber: 0, saldo: 127376.87},

    {fecha: "07-dic", tipo: "Mercado Pago", credito: 0, haber: 0, saldo: 51637.13},
    {fecha: "07-dic", tipo: "Factura 46014", credito: 4056.10, haber: 0, saldo: 71637.13},

    {fecha: "04-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 67581.03},
    {fecha: "05-dic", tipo: "Mercado Pago", credito: 0, haber: 0, saldo: 87581.03},
    {fecha: "05-dic", tipo: "Factura 45978", credito: 51689.30, haber: 0, saldo: 102581.03},
...
const guillermo = [
    ...
    {fecha: "05-ene", tipo: "Pago efcetivo", credito: 0, haber: 80000, saldo: 19825.69},
    {fecha: "05-ene", tipo: "Factura 46072", credito: 58777.55, haber: 0, saldo: 99825.69},

    {fecha: "22-dic", tipo: "Pago efcetivo", credito: 0, haber: 90000, saldo: 56953.37},
    {fecha: "22-dic", tipo: "Factura 45868", credito: 112477.42, haber: 0, saldo: 146953.37},

    {fecha: "15-dic", tipo: "Factura 45782", credito: 104475.97, haber: 70000, saldo: 34475.97},

    {fecha: "08-dic", tipo: "Pago efectivo", credito: 0, haber: 35000, saldo: 481.66},
    {fecha: "08-dic", tipo: "Factura 45672", credito: 24776.51, haber: 0, saldo: 35481.66},
...
const mirta = [
    {fecha: "05-feb", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 35844.63},
    ...
    {fecha: "25-ene", tipo: "Mercado Pago", credito: 0, haber: 21000, saldo: 73141.63},
    {fecha: "25-ene", tipo: "Factura 46340", credito: 65382.21, haber: 0, saldo: 94141.63},

    {fecha: "23-ene", tipo: "Mercado Pago", credito: 0, haber: 15000, saldo: 28759.42},
    ...
    {fecha: "08-ene", tipo: "Mercado Pago", credito: 0, haber: 25000, saldo: 29793.05},
    {fecha: "04-ene", tipo: "Mercado Pago", credito: 0, haber: 10000, saldo: 54793.05},
    {fecha: "04-ene", tipo: "Factura 46034", credito: 44179.58, haber: 0, saldo: 64793.05},

    {fecha: "02-ene", tipo: "Mercado Pago", credito: 0, haber: 25000, saldo: 20613.47},
    {fecha: "28-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 45613.47},
    {fecha: "28-dic", tipo: "Factura 45952", credito: 16700.52, haber: 0, saldo: 65613.47},

    {fecha: "26-dic", tipo: "Mercado Pago", credito: 0, haber: 10000, saldo: 48912.95},
    {fecha: "21-dic", tipo: "Mercado Pago", credito: 0, haber: 10000, saldo: 58912.95},
    {fecha: "21-dic", tipo: "Fcatura 45854", credito: 38542.39, haber: 0, saldo: 68912.95},

    {fecha: "19-dic", tipo: "Mercado Pago", credito: 0, haber: 15000, saldo: 30370.56},
    {fecha: "19-dic", tipo: "Fcatura 45814", credito: 22140.80, haber: 0, saldo: 45370.56},

    {fecha: "18-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 23229.76},
    {fecha: "18-dic", tipo: "Factura 45794", credito: 13877.68, haber: 0, saldo: 43229.76},

    {fecha: "14-dic", tipo: "Mercado Pago", credito: 0, haber: 18000, saldo: 29352.08},
    {fecha: "14-dic", tipo: "Factura 45750", credito: 16858.14, haber: 0, saldo: 47352.08},    

    {fecha: "11-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 30493.94},    
    {fecha: "07-dic", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 50493.94},    
    {fecha: "07-dic", tipo: "Factura 46034", credito: 43280.24, haber: 0, saldo: 70493.94},    
...
const melisa = [
    ...
    {fecha: "07-dic", tipo: "Factura 46016", credito: 8732.72, haber: 6000, saldo: 2732.72},
...
const jorge = [
    {fecha: "05-feb", tipo: "Pago efectivo", credito: 0, haber: 30000, saldo: 33482.77},
    {fecha: "05-feb", tipo: "Factura 46490", credito: 48482.77, haber: 0, saldo: 63482.77},
    ...
    {fecha: "08-ene", tipo: "Pago efectivo", credito: 0, haber: 32644.55, saldo: 30000},
    {fecha: "08-ene", tipo: "Factura 46094", credito: 37279.33, haber: 0, saldo: 62644.55},

    {fecha: "02-ene", tipo: "Pago efectivo", credito: 0, haber: 30000, saldo: 25365.22},
    {fecha: "02-ene", tipo: "Factura 46000", credito: 45365.22, haber: 0, saldo: 55365.22},

    {fecha: "26-dic", tipo: "Pago efectivo", credito: 0, haber: 18656.76, saldo: 10000},
    {fecha: "21-dic", tipo: "Pago efectivo", credito: 0, haber: 30000, saldo: 28656.76},
    {fecha: "21-dic", tipo: "Factura 45856", credito: 11656.76, haber: 0, saldo: 56656.76},

    {fecha: "18-dic", tipo: "Pago efectivo", credito: 0, haber: 51152.56, saldo: 47000},
    {fecha: "18-dic", tipo: "Factira 45792", credito: 52768.11, haber: 0, saldo: 98152.56},

    {fecha: "14-dic", tipo: "Pago efectivo", credito: 0, haber: 40000, saldo: 45384.44},
    {fecha: "14-dic", tipo: "Factura 45754", credito: 55210.89, haber: 0, saldo: 85384.42},

    {fecha: "11-dic", tipo: "Pago efectivo", credito: 0, haber: 40000, saldo: 30173.53},
    {fecha: "11-dic", tipo: "Factura 45680", credito: 55173.53, haber: 0, saldo: 70173.53},

    {fecha: "07-dic", tipo: "Pago efectivo", credito: 0, haber: 15000, saldo: 15000},
...
const emilse = [
    {fecha: "05-feb", tipo: "Factura 46482", credito: 62915.81, haber: 0, saldo: 62915.81},

    {fecha: "29-ene", tipo: "Pago efcetivo", credito: 0, haber: 78923.29, saldo: 0},
    ...
    {fecha: "08-ene", tipo: "Factura 46096", credito: 50869.10, haber: 0, saldo: 50869.10},
    {fecha: "08-ene", tipo: "Mercado Pago", credito: 0, haber: 44054.07, saldo: 0},
    
    {fecha: "02-ene", tipo: "Factura 45992", credito: 44054.07, haber: 0, saldo: 44054.07},
    {fecha: "02-ene", tipo: "Mercado Pago", credito: 0, haber: 64452.13, saldo: 0},

    {fecha: "26-dic", tipo: "Factura 45920", credito: 64452.13, haber: 0, saldo: 64452.13},
    {fecha: "26-dic", tipo: "Mercado Pago", credito: 60846.01, haber: 0, saldo: 0},

    {fecha: "18-dic", tipo: "Factura 45796", credito: 60846.01, haber: 0, saldo: 60846.01},
    {fecha: "18-dic", tipo: "Mercado Pago", credito: 0, haber: 49246.18, saldo: 0},

    {fecha: "11-dic", tipo: "Factura 45676", credito: 49246.18, haber: 0, saldo: 49246.18},
    {fecha: "11-dic", tipo: "Mercado Pago", credito: 0, haber: 57744.66, saldo: 0},
...
const carlos = [
    ...
    {fecha: "05-ene", tipo: "Factura 46076", credito: 57496.07, haber: 0, saldo: 57272.71},

    {fecha: "05-ene", tipo: "Efectivo", credito: 0, haber: 66500, saldo: -223.36},
    {fecha: "05-ene", tipo: "Mercado Pago", credito: 0, haber: 24000, saldo: 662796.64},
    {fecha: "04-ene", tipo: "Mercado Pago", credito: 0, haber: 55800, saldo: 90276.64},
    {fecha: "27-dic", tipo: "Factura 45940", credito: 146076.64, haber: 0, saldo: 146076.64},
    {fecha: "27-dic", tipo: "Mercado Pago", credito: 0, haber: 79651.68, saldo: 0},

    {fecha: "26-dic", tipo: "Mercado Pago", credito: 0, haber: 56600, saldo: 79651.65},
    {fecha: "26-dic", tipo: "Pago efectivo", credito: 0, haber: 35000, saldo: 136251.66},
    {fecha: "22-dic", tipo: "Factura 45898", credito: 135012.25, haber: 0, saldo: 171251.66},

    {fecha: "22-dic", tipo: "Mercado Pago", credito: 0, haber: 27000, saldo: 36239.41},
    {fecha: "21-dic", tipo: "Mercado Pago", credito: 0, haber: 17000, saldo: 63239.41},
    {fecha: "20-dic", tipo: "Mercado Pago", credito: 0, haber: 26500, saldo: 80239.41},
    {fecha: "19-dic", tipo: "Mercado Pago", credito: 0, haber: 18000, saldo: 106739.41},
    {fecha: "12-dic", tipo: "Factura 45700", credito: 124739.41, haber: 0, saldo: 124739.41},

    {fecha: "12-dic", tipo: "Mercado Pago", credito: 0, haber: 28564.91, saldo: 0},
    {fecha: "11-dic", tipo: "Mercado Pago", credito: 0, haber: 70000, saldo: 28564.91},
    {fecha: "07-dic", tipo: "Mercado Pago", credito: 0, haber: 7000, saldo: 98564.91},
    {fecha: "05-dic", tipo: "Mercado Pago", credito: 0, haber: 2360, saldo: 105564.91},
    {fecha: "05-dic", tipo: "Factura 45996", credito: 107924.91, haber: 0, saldo: 107924.91},

    {fecha: "05-dic", tipo: "mercado Pago", credito: 0, haber: 33814.93, saldo: 0},
    {fecha: "04-dic", tipo: "Mercado Pago", credito: 0, haber: 61780, saldo: 33814.93},
...
const rossana = [
    {fecha: "05-feb", tipo: "Mercado Pago", credito: 0, haber: 17531.54, saldo: 0},
    ...
    {fecha: "03-ene", tipo: "Factura 46030", credito: 11548.80, haber: 0, saldo: 11548.80}, 
    {fecha: "03-ene", tipo: "Pago efectivo", credito: 0, haber: 9898.95, saldo: 0},

    {fecha: "26-dic", tipo: "Factura 45808", credito: 9898.95, haber: 0, saldo: 9898.95}, 
    {fecha: "26-dic", tipo: "Pago efectivo", credito: 13233.20, haber: 0, saldo: 0},

    {fecha: "19-dic", tipo: "Factura 45808", credito: 13233.20, haber: 0, saldo: 13233.20}, 
    {fecha: "19-dic", tipo: "Pago efectivo", credito: 5989.70, haber: 0, saldo: 0},

    {fecha: "12-dic", tipo: "Factura 45714", credito: 5989.70, haber: 0, saldo: 5989.70}, 
    {fecha: "12-dic", tipo: "Pago efectivo", credito: 0, haber: 9395.46, saldo: 0},

    {fecha: "05-dic", tipo: "Factura 45994", credito: 9395.46, haber: 0, saldo: 9395.46}, 
    {fecha: "05-dic", tipo: "Pago efectivo", credito: 0, haber: 10627.38, saldo: 0},
...
const fernando = [
    {fecha: "07-feb", tipo: "Mercado Pago", credito: 0, haber: 20000, saldo: 32155.92},
    {fecha: "07-feb", tipo: "Factura 46514", credito: 6050.6, haber: 0, saldo: 52155.92},
    ...
    {fecha: "10-ene", tipo: "Mercdao Pago", credito: 0, haber: 20000, saldo: 28737.80},
    {fecha: "09-ene", tipo: "Factura 46110", credito: 27118.41, haber: 0, saldo: 48737.80},

    {fecha: "08-ene", tipo: "Mercado pago", credito: 0, haber: 10000, saldo: 21619.39},
    {fecha: "04-ene", tipo: "Mercado pago", credito: 0, haber: 20000, saldo: 31619.39},
    {fecha: "03-ene", tipo: "Factura 46024", credito: 19379.26, haber: 0, saldo: 51619.39},

    {fecha: "22-dic", tipo: "Mercado Pago", credito: 0, haber: 10000, saldo: 32240.13},
    {fecha: "20-dic", tipo: "Mercado Pago", credito: 0, haber: 25000, saldo: 42240.13},
    {fecha: "19-dic", tipo: "Factura 45816", credito: 40267.82, haber: 0, saldo: 67240.13},

    {fecha: "12-dic", tipo: "Mercado Pago", credito: 0, haber: 25000, saldo: 26972.31},
    {fecha: "12-dic", tipo: "Factura 45696", credito: 32913.77, haber: 0, saldo: 51972.31},
...
const emanuel = [
    ...
    {fecha: "09-ene", tipo: "Factura 46102", credito: 30668.11, haber: 20167, saldo: 10501.11},
